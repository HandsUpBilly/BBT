...
export const TUTORIAL_LESSONS: readonly TutorialLesson[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'LOCKSTEP: A move is replayed automatically into every universe where it stays legal and needs the same dice. An unchanged pickup roll stays together; a pickup or dodge whose target changes because a marker is still standing does not. Push Back and Push Back + Down usually want the same next move, so lockstep plays it once for both.',
